...
set rc [catch {
  ...
  open_checkpoint Atari7800_routed.dcp
  set_property webtalk.parent_dir /afs/ece.cmu.edu/usr/cmbarker/Private/Atari7800/maria/maria.cache/wt [current_project]
  write_bitstream -force Atari7800.bit 
  catch { write_sysdef -hwdef Atari7800.hwdef -bitfile Atari7800.bit -meminfo Atari7800.mmi -ltxfile debug_nets.ltx -file Atari7800.sysdef }

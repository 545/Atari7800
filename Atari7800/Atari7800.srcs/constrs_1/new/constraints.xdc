...
connect_debug_port u_ila_0_0/probe0 [get_nets [list {console/vga_out/tia_write_row_kept[0]} {console/vga_out/tia_write_row_kept[1]} {console/vga_out/tia_write_row_kept[2]} {console/vga_out/tia_write_row_kept[3]} {console/vga_out/tia_write_row_kept[4]} {console/vga_out/tia_write_row_kept[5]} {console/vga_out/tia_write_row_kept[6]} {console/vga_out/tia_write_row_kept[7]}]]
create_debug_port u_ila_0_0 probe
set_property port_width 8 [get_debug_ports u_ila_0_0/probe1]
connect_debug_port u_ila_0_0/probe1 [get_nets [list {console/vga_out/tia_write_col_kept[0]} {console/vga_out/tia_write_col_kept[1]} {console/vga_out/tia_write_col_kept[2]} {console/vga_out/tia_write_col_kept[3]} {console/vga_out/tia_write_col_kept[4]} {console/vga_out/tia_write_col_kept[5]} {console/vga_out/tia_write_col_kept[6]} {console/vga_out/tia_write_col_kept[7]}]]
create_debug_port u_ila_0_0 probe
set_property port_width 8 [get_debug_ports u_ila_0_0/probe2]
connect_debug_port u_ila_0_0/probe2 [get_nets [list {console/vga_out/tia_uv_kept[0]} {console/vga_out/tia_uv_kept[1]} {console/vga_out/tia_uv_kept[2]} {console/vga_out/tia_uv_kept[3]} {console/vga_out/tia_uv_kept[4]} {console/vga_out/tia_uv_kept[5]} {console/vga_out/tia_uv_kept[6]} {console/vga_out/tia_uv_kept[7]}]]
create_debug_port u_ila_0_0 probe
set_property port_width 15 [get_debug_ports u_ila_0_0/probe3]
connect_debug_port u_ila_0_0/probe3 [get_nets [list {console/vga_out/buf_w_addr_kept[0]} {console/vga_out/buf_w_addr_kept[1]} {console/vga_out/buf_w_addr_kept[2]} {console/vga_out/buf_w_addr_kept[3]} {console/vga_out/buf_w_addr_kept[4]} {console/vga_out/buf_w_addr_kept[5]} {console/vga_out/buf_w_addr_kept[6]} {console/vga_out/buf_w_addr_kept[7]} {console/vga_out/buf_w_addr_kept[8]} {console/vga_out/buf_w_addr_kept[9]} {console/vga_out/buf_w_addr_kept[10]} {console/vga_out/buf_w_addr_kept[11]} {console/vga_out/buf_w_addr_kept[12]} {console/vga_out/buf_w_addr_kept[13]} {console/vga_out/buf_w_addr_kept[14]}]]
create_debug_port u_ila_0_0 probe
set_property port_width 15 [get_debug_ports u_ila_0_0/probe4]
connect_debug_port u_ila_0_0/probe4 [get_nets [list {console/vga_out/buf_r_addr_kept[0]} {console/vga_out/buf_r_addr_kept[1]} {console/vga_out/buf_r_addr_kept[2]} {console/vga_out/buf_r_addr_kept[3]} {console/vga_out/buf_r_addr_kept[4]} {console/vga_out/buf_r_addr_kept[5]} {console/vga_out/buf_r_addr_kept[6]} {console/vga_out/buf_r_addr_kept[7]} {console/vga_out/buf_r_addr_kept[8]} {console/vga_out/buf_r_addr_kept[9]} {console/vga_out/buf_r_addr_kept[10]} {console/vga_out/buf_r_addr_kept[11]} {console/vga_out/buf_r_addr_kept[12]} {console/vga_out/buf_r_addr_kept[13]} {console/vga_out/buf_r_addr_kept[14]}]]
create_debug_port u_ila_0_0 probe
set_property port_width 10 [get_debug_ports u_ila_0_0/probe5]
connect_debug_port u_ila_0_0/probe5 [get_nets [list {console/vga_row[0]} {console/vga_row[1]} {console/vga_row[2]} {console/vga_row[3]} {console/vga_row[4]} {console/vga_row[5]} {console/vga_row[6]} {console/vga_row[7]} {console/vga_row[8]} {console/vga_row[9]}]]
create_debug_port u_ila_0_0 probe
set_property port_width 10 [get_debug_ports u_ila_0_0/probe6]
connect_debug_port u_ila_0_0/probe6 [get_nets [list {console/vga_col[0]} {console/vga_col[1]} {console/vga_col[2]} {console/vga_col[3]} {console/vga_col[4]} {console/vga_col[5]} {console/vga_col[6]} {console/vga_col[7]} {console/vga_col[8]} {console/vga_col[9]}]]
create_debug_port u_ila_0_0 probe
set_property port_width 8 [get_debug_ports u_ila_0_0/probe7]
connect_debug_port u_ila_0_0/probe7 [get_nets [list {console/uv_tia[0]} {console/uv_tia[1]} {console/uv_tia[2]} {console/uv_tia[3]} {console/uv_tia[4]} {console/uv_tia[5]} {console/uv_tia[6]} {console/uv_tia[7]}]]
create_debug_port u_ila_0_0 probe
set_property port_width 1 [get_debug_ports u_ila_0_0/probe8]
connect_debug_port u_ila_0_0/probe8 [get_nets [list console/cpu_inst/rdy_in]]
create_debug_port u_ila_0_0 probe
set_property port_width 1 [get_debug_ports u_ila_0_0/probe9]
connect_debug_port u_ila_0_0/probe9 [get_nets [list console/vga_hsync_kept]]
create_debug_port u_ila_0_0 probe
set_property port_width 1 [get_debug_ports u_ila_0_0/probe10]
connect_debug_port u_ila_0_0/probe10 [get_nets [list console/vga_vsync_kept]]
